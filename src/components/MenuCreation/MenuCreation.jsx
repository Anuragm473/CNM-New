...
//         try {
//           const response = await axios.get(`https://caterersnearme.in/api/caterer/${catererId}`);
...
//         try {
//           const response = await axios.get(`https://caterersnearme.in/api/menus?limit=1000000`);
...
//                         const response = await axios.patch(`https://caterersnearme.in/api/menus/${menu.id}`, payload);
//                         
...
//                     }
//                 } else {
//                     const response = await axios.post('https://caterersnearme.in/api/menus', payload);
//                     
//                     return response.status >= 200 && response.status < 300;
//                 }
//             });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      for (const id of deletedMenuIds) {
        await axios.delete(`https://caterersnearme.in/api/menus/${id}`);
